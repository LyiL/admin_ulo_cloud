import {HostListener, Input, Output, Directive, EventEmitter, ElementRef} from "@angular/core";
import {UploadRejected, MdUploader} from "./uploader";
@Directive({
  selector: '[uloFileSelect]',
})
export class UloFileSelectDirective {
