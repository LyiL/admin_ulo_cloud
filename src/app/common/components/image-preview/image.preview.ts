...
import {ULOImagePreviewService, ImageType} from "./image.preview.service";
@Component({
  selector:"ulo-image-preview",
  templateUrl:"image.preview.html",
  styleUrls:["image.preview.scss"]
})
export class ULOImagePreview{
  ...
  constructor(private imgService:ULOImagePreviewService,private render2:Renderer2){
    //监控图片资源
  ...
  onLoadImgError(e:Event){
    ...
    if(target && target['src']){
      target['src'] = 'webassets/images/img_load_err.png';
    }
