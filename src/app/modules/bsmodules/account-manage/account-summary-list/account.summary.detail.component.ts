...
export class AccountSummaryDetailComponent{
  public accountSummaryDetailReqParam:any;
  ...
  constructor(public sidenavService: ISidenavSrvice,public helper: HelpersAbsService){
    ...
    //对账概要详情信息
    this.accountSummaryDetailReqParam = {
      url: '/pctsManager/seachPctsById',
      params: params
    };
  }
  backToList(){
    this.sidenavService.onNavigate('/admin/accountsummary', '对账概要', [], true);
  }
}
